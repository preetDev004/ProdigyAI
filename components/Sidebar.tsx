          ...
          {routes &&
            routes.map((route, index) => (
              <Link
                ...
                key={index}
                className={cn(
                  "text-sm group flex justify-start w-auto mx-1 p-3 overflow-hidden font-md cursor-pointer hover:text-white  hover:bg-white/10 rounded-lg transition",
                  pathname === route.href
